...
use DataTables;
use DB;
class ElectricMeterReadingController extends Controller
{
    public $months = [
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('house_name', function ($row) {
                    return $row->flatRent->house->name;
                })
                ->addColumn('flat_name', function ($row) {
                    return $row->flatRent->flat->flat_number;
                })
                ->addColumn('mobile_no', function ($row) {
                    return $row->flatRent->mobile_no;
                })
