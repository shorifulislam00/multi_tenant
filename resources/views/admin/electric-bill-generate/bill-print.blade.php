    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 px-1">
                <div class="card">
                    <div class="card-header">{{ __('Bill print') }}</div>

                    <div class="card-body">
                        <form method="GET" action="{{ route('bill.report_print')}}" target="_blank">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                {{--  <div class="col-md-3">
                                    <label for="date" class="form-label">{{ __('House') }}</label>
